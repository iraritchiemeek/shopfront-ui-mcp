...
/**
 * MCP Apps host CSS variables — simulates what the host injects via
 * `useHostStyles` in production. Adapted from PostHog's McpThemeDecorator.
...
export const McpThemeDecorator: Decorator = (Story) => (
  <div
    style={
      {
        ...mcpAppsCssVariables,
